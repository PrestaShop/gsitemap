...
docker exec -t temp-ps rm -rf /var/www/html/modules/%module%
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/%module% \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/%module% phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/%module%/%dirPHPStan%/phpstan-$PS_VERSION.neon
